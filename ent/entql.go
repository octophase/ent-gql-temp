...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[0] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			group.FieldUsername: {Type: field.TypeString, Column: group.FieldUsername},
		},
	}
...
func (f *GroupFilter) WhereUsername(p entql.StringP) {
	f.Where(p.Field(group.FieldUsername))
}
